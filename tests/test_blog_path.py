...
def test_generate_path_should_with_relative_destination_path_generate_correct_path():
    input_path = '/not-needed-path/main-website/blog/2016-03-30-something-that-happened.html'
    destination_prefix = 'www/'
    left_path_trim = '/not-needed-path/main-website/'
    expected_result = 'www/blog/2016/03/30/something-that-happened.html'
...
def test_splitpath_without_prefix_or_left_trim_returns_correct_list():
    input_path = '2016-03-30-something-that-happened.html'
    destination_prefix = ''
    left_path_trim = ''
    expected_result = ['2016', '03', '30', 'something-that-happened.html']
    actual_result, _ = split_path(input_path, destination_prefix, left_path_trim)
    assert expected_result == actual_result

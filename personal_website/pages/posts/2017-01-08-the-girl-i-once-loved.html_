{% extends "base.html" %}
{#layout: post#}
{% block title %}The Girl I Once Loved{% endblock %}
...
<p>When I first started writing this blog, I thought it would be completely technical. But, all of a sudden I started
    ...
    fill up that hole in my heart.</p>

<p>This is from the time I was in my engineering college in Goa. I used to see her at the college, she was my junior. I
    ...
    had exchanged numbers at that time, again through Facebook.</p>

<p>Once there was a meeting in the college for organising a technical event for the college. We were all sitting and
...
<p>Next to the college, we had a snack joint called Monginis, where we used to just sit and talk. It was the time after
    ...
    wife'. She was pretty shocked with this statement but it hit her heart which she told me later on.</p>

<p>Apart from Monginis we both used to hang out at a juice joint called Frutilicious. We both used to sit there after
    ...
    destination, I used to wait at the destination bus stop till she left after saying bye.</p>

<p>We had a lot of sweet memories on the beaches we used to roam on. On rare occasions, we used to visit beaches. She
    ...
    drowsy and I took care that she could get a short nap in the crowd of people watching the event live.</p>

<p>Finally, I was done with my college and she had another year to go. I was obsessed with getting a master's degree,
    ...
    the final chapter of my relationship started.</p>

<p>Everything does not have to end, some things stay for a very long time in this universe. The life span is very
    ...
    both had some expectations from each other that we could not satisfy.</p>
...
{% endblock %}
{% block meta_vars %}
    {% set tags = write_tags(['life', 'about me', 'love', 'relationship']) %}
    {% set desc = write_description('A story about someone I once loved, where the text written for this blog just came flowing out in a way just like emotions come flowing out') %}
    {% set title = write_title('The Girl I Once Loved') %}
{% endblock %}
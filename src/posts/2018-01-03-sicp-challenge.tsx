...
export const data = {
  ...
  id: 'sicp-challenge',
  date: { year: '2018', month: '01', day: '03' },
  title: 'My SICP Challenge!',
  description: 'As the new year starts, someone like me who does not like new year resolutions takes up a challenge (not exactly a resolution) to study the whole SICP book',
  thumb: '/images/sicp-wizard.png',
}
...
export default () => (
    <div>
      ...
      <img src="/images/sicp-wizard.png" className='center' />

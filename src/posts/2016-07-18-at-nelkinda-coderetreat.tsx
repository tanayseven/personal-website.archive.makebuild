...
const data = {
  ...
  thumb: '/images/code_retrospective_nelkinda.jpg',
}
...
export default () => (
    <div>
      <p>
        ...
        for <a href="http://nelkinda.com/events/2016-07-16-4th-Nelkinda-Coderetreat"> Coderetreat that’s
        held at Nelkinda</a> which was on 16th of July 2016. Facilitated
        by <a href="https://twitter.com/SiddheshNikude"> Siddhesh Nikude </a>
        and <a href="https://twitter.com/ShwetaSadawarte"> Shweta Sadawarte</a> it was a long but a really
        nice event. More than anything else I got to learn a lot from that event and I will write
      ...
      <img alt="code_retrospective" className='center' src="/images/code_retrospective_nelkinda.jpg" />
      ...
      <p>
        Later I was paired with my friend <a href="https://twitter.com/Mistcrafter">Douglas Vaz</a>

...
export default () => (
  <div>
    ...
    <img alt="emulator" src="/images/smserver_images/01_emulator.png" />

    <h3>This is the starting screen when you first start the app</h3>
    <img alt="start_screen" src="/images/smserver_images/02_start_screen.png" />

    <h3>Now you click on the right-top corner menu button for creating a new form</h3>
    <img alt="main_menu" src="/images/smserver_images/03_main_menu.png" />

    <h3>These are the details that you have to fill up to accept registrations</h3>
    <img alt="new_form" src="/images/smserver_images/04_new_form.png" />

    <h3>Also included, date and time selectors</h3>
    <img alt="calender_selector" src="/images/smserver_images/05_calender_selector.png" />

    <h3>Fill up this form</h3>
    <img alt="filled_form" src="/images/smserver_images/07_filled_form.png" />
    ...
    <img alt="main_screen_form_created" src="/images/smserver_images/10_main_screen_form_created.png" />

    <h3>You can either open the form</h3>
    <img alt="form_menu" src="/images/smserver_images/08_form_menu.png" />

    <h3>After opening the form you can see the details of the form</h3>
    <img alt="opened_form_no_entries" src="/images/smserver_images/09_opened_form_no_entries.png" />
    ...
    <img alt="entry_made" src="/images/smserver_images/11_entry_made.png" />
    ...
    <img alt="server_running_in_background" src="/images/smserver_images/12_server_running_in_background.png" />

{% extends "base.html" %}
{% block meta_vars %}
    {% set tags = ['introduction', 'about me', 'initial post'] %}
    {% set desc = 'My first post on this blog. It is called hello world because when learning a programming language, it is usually the first program that is written' %}
...
{% block main_content %}
    ...
    <p>This blog will be dedicated to writing a lot of things, mainly about different things I learn while coding and some
        ...
        grammar and vocabulary to write? I'll just write and put my own content here.</p>

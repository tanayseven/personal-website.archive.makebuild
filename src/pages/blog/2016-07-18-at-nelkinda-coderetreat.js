...
{% block meta_vars %}
    {% set tags = [
        'event', 'coding', 'programming', 'test driven deveopment', 'behaviour driven development'
       ]
    %}
    {% set desc = 'A review and my feeling about a coding event called as Coderetreat which was held at Nelkinda Software Craft Pvt Ltd. Also, this post describes how the whole event went and how good it was and what someone can possibly learn from a Coderetreat.' %}
    {% set title = 'At Nelkinda Coderetreat' %}
    {% if save_data %}
        {% set _ = save_data(title, desc) %}
    {% endif %}
{% endblock %}
{#layout: post#}
{% block title %}At Nelkinda Coderetreat{% endblock %}
{#categories: [events]#}
...
<img alt="code_retrospective" class="center" src="/res/images/code_retrospective_nelkinda/code_retrospective_nelkinda.jpg">
